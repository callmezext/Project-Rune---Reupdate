  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-6 items-start">
        {/* Left Column: Creator Profile & Achievements */}
        ...
        {/* Right Column: Linked Logins & Security */}
        <div className="md:col-span-2 space-y-6">
          {/* ═══ Linked Logins ═══ */}
          <div className="glass-card p-6">
            <h3 className="font-bold text-lg mb-1">Linked Logins</h3>
            <p className="text-xs text-text-muted mb-5">Manage your authentication methods and social logins.</p>
            
            {/* Social Connection Redirect Banner */}
            <div className="p-3.5 rounded-xl bg-accent/5 border border-accent/15 flex items-center justify-between gap-3 mb-5">
              <div className="min-w-0">
                <div className="text-[10px] font-extrabold text-accent-light uppercase tracking-wider">TikTok Creator Account</div>
                <div className="text-xs text-text-secondary mt-0.5">Link your TikTok profile to submit campaign content.</div>
              </div>
              <Link href="/accounts" className="px-3 py-1.5 rounded-lg bg-accent/15 text-accent-light text-[11px] font-bold hover:bg-accent/25 transition-all shrink-0">
                Manage
              </Link>
            </div>
            ...
            <div className="space-y-3">
              {/* ── Username (Permanent) ── */}
              <div className="flex items-center justify-between p-4 rounded-xl bg-bg-primary/50 border border-border gap-3">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-xs text-text-muted font-mono truncate">@{profile.username}</div>
                  </div>
                </div>
                <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-bg-tertiary text-text-muted text-xs font-semibold shrink-0">
                  ...
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <div className="text-sm font-medium flex items-center gap-1.5">
                        Email & Password
                        <span className="inline-flex items-center text-[10px] text-success bg-success/10 px-1.5 py-0.5 rounded font-bold">
                          ✓ Linked
                        </span>
                      </div>
              ...
              <div className="flex items-center justify-between p-4 rounded-xl bg-bg-primary/50 border border-border gap-3">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-xs text-text-muted truncate">{profile.hasGoogle ? "Account linked" : "Not connected"}</div>
                  </div>
                </div>
                {profile.hasGoogle ? (
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg bg-error/10 text-error text-xs font-medium hover:bg-error/20 transition-colors disabled:opacity-50 shrink-0"
                  >
                    Unbind
                  </button>
                ) : (
                  <button
                    ...
                    className="px-4 py-1.5 rounded-lg bg-accent/15 text-accent-light text-xs font-semibold hover:bg-accent/25 transition-colors shrink-0"
                  >
                    Connect
                  </button>
                )}
              ...
              <div className="flex items-center justify-between p-4 rounded-xl bg-bg-primary/50 border border-border gap-3">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-xs text-text-muted truncate">{profile.hasDiscord ? `@${profile.discordUsername || "linked"}` : "Not connected"}</div>
                  </div>
                </div>
                {profile.hasDiscord ? (
                  <button
                  ...
                  <button
                    ...
                    className="px-4 py-1.5 rounded-lg bg-[#5865F2]/15 text-[#5865F2] text-xs font-semibold hover:bg-[#5865F2]/25 transition-colors shrink-0"
                  >
                    Connect
                  </button>
                )}
